// Named MCP bearer tokens. CAPTURE_SECRET (env) authorizes the UI and the
// non-MCP HTTP surface; the tokens listed here are the ONLY way to reach the
// MCP transport from outside. See `tasks/todo.md` (MCP token management) for
// the auth-split decision.
//
